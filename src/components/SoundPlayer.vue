<template>
    <div class="sounds_players_container" >
        <div class="player_container" v-for="(song, index) in songs" :key="song.name">
            <div class="song_info">
            ...
            <div class="song_duration song_duration">
                <input type="range" min="0" max="100" value="0" class="duration duration_dmc" @change="change_duration_dmc(index)">
            </div>
            <div class="play_button" @click="isPlaying === false ? play_track(index) : pause_track(index)">
                <div class="play_icon">
        ...
        <div class="player_bottom_bar">
            ...
            <div class="song_duration">
                <input type="range" min="0" max="100" value="0" name="duration" class="duration duration_non-dmc" @change="change_duration_non_dmc(prevPlayed)">
            </div>
            <div class="bottom_buttons">
                <div class="prev_button" @click="prev_track()">
                    <img src="@/assets/next.png" />
                </div>
                <div class="play_bottom_button" @click="isPlaying === false ? play_track(prevPlayed) : pause_track(prevPlayed)">
            ...
            <div class="volume_container">
                ...
                <input type="range" name="volume" id="volume" min="0" max="100" value="50" @change="change_volume()">
            </div>
    ...
    methods: {
        play_track(index) {
            ...
            if (this.isPlaying === false) {
                const songName = document.querySelector('.player_bottom_bar .song_info .song_name');
                const songAuthor = document.querySelector('.player_bottom_bar .song_info .song_author');
                const playIcon = document.querySelectorAll('.player_container .play_icon img');
                ...
                setInterval(() => {
                    const durationBars = document.querySelectorAll('.sounds_players_container .duration_dmc'); // dynamicaly rendered
                    const durationPlayer = document.querySelector('.sounds_players_container .duration_non-dmc'); // non-dynamicaly rendered
        ...
        change_duration_dmc(index) { // change track duration bar for tracks (dynamicaly rendered)
            const durationBars = document.querySelectorAll('.sounds_players_container .duration_dmc')

            this.sliderPosition = this.track.duration * (durationBars[index].value / 100);
            this.track.currentTime = this.sliderPosition;
        },
        change_duration_non_dmc() { // change track duration bar for bottom player (non dynamicaly rendered)
            const durationPlayer = document.querySelector('.sounds_players_container .duration_non-dmc');
